...
@MainActor
class CodeIslandAppDelegate: NSObject, NSApplicationDelegate {
    static let shared = CodeIslandAppDelegate()
    ...
    /// Called by LilAgents AppDelegate to start CodeIsland functionality
    func startCodeIsland() {
